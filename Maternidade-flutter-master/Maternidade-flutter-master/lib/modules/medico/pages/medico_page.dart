...
class _MedicoPageState extends State<MedicoPage> {
  ...
  void submit(String action, MedicoData medicoData) {
    if (_formKey.currentState!.validate()) {
      ...
      if (medicoData.nome == "") {
        ...
        Fluttertoast.showToast(
            msg: 'Por favor, informe o especialidade!',
            toastLength: Toast.LENGTH_LONG,
            gravity: ToastGravity.CENTER,
            backgroundColor: Colors.red,
            fontSize: 20.0);
      } else if (medicoData.telefone == "") {
        Fluttertoast.showToast(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                        ...
                        initialValue: medicoData.telefone,
                        onSaved: (String? value) {
                          medicoData.telefone = value!;
                        }),
                    TextFormField(
                        scrollPadding: EdgeInsets.only(bottom: MediaQuery.of(context).viewInsets.bottom),
                        decoration: const InputDecoration(
                            hintText: 'Email', labelText: 'Email'),
                        initialValue: medicoData.email,
                        onSaved: (String? value) {
                          medicoData.email = value!;
                        }),
                    const SizedBox(
                      height: 20,
                    ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Gerenciar Medicos'),
      ),
      body: Center(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(_medico[index].telefone!),
                        trailing: SizedBox(
                          width: 100,
                          child: Row(
                            children: [
